...
int main()
{
    ...
    // Part 2
    {
        ...
        // Define derivative function.
        auto df = [](auto x) { return 42*x; }; // HINT: this derivative is wrong...!
    ...
    */
    ...
    // That is a "problem" with Newton's method: it is not guaranteed to converge,
    // and may not converge to the root closest to the start point.
    // See a textbook for convergence criteria.
}
