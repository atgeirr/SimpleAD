...
\date[Geilo 2019]{INSPIRE summer school 2019 \\ Geilo, August 1, 2019}
...
\begin{frame}
  ...
  Performance (of equation assembly) will usually be somewhat slower than a
...
\begin{frame}
  ...
  No longer used:
  \begin{myblock}{\code{class AutoDiffBlock}}
    \begin{itemize}
    \item class implementing {\em forward AD}
    \item deals with {\em vectors of values} at a time
    \item derivatives are {\em sparse matrices}
    \item implemented with operator overloading
    \item based on Eigen library for basic types and operands
    \item helper library provides discrete div, grad etc.
    \end{itemize}
  \end{myblock}
  \bigskip
